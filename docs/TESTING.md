...
For docs lifecycle changes such as `/opencode-coder/create-docs`, `/opencode-coder/init-or-update-docs`, `/opencode-coder/improve-doc`, `/opencode-coder/review-docs`, and `/opencode-coder/init`:
