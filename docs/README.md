...
| `user-guide/project-setup.md` | User-guide copy of the canonical project-doc structure reference under `ai-resources/skills/coder-docs/references/` |
| `user-guide/project-doc-guidelines.md` | User-guide copy of the canonical project-doc authoring rules under `ai-resources/skills/coder-docs/references/` |
| `user-guide/project-doc-review-guidelines.md` | User-guide copy of the canonical reviewer checklist under `ai-resources/skills/coder-docs/references/` |
